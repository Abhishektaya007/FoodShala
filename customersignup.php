<html>
<head>
    <title> Guest Signup | Food-Shala </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit"> Food-Shala </span></h1>
     <br>
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="category" type="text" name="category" placeholder="Veg / Non Veg" required>
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="glyphicon glyphicon-cutlery" aria-hidden="true"></label>
            </span>
              </span>
            </div>           
          </div>
