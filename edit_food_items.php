...
<html>
  ...
  <head>
    <title> Manager Login | Food-Shala </title>
  </head>
 ...
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="dcategory" name="dcategory" value=<?php echo $row1['category'];  ?> placeholder="Veg/Non-Veg" required="">
          </div>
